...
; RUN: %jfs -cxx --branch-encoding=try-all --disable-equality-extraction --disable-standard-passes -libfuzzer-runs=100 -libfuzzer-seed=1  -stats-file=%t-stats.yml -record-max-num-satisfied-constraints %s | %FileCheck -check-prefix=CHECK-SAT %s
